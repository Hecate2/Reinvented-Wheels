...
allowed_apps = {'com.xunmeng.pinduoduo', "com.sankuai.meituan", 'com.taobao.tao', "com.cat.readall"}
...
def gen_swipe_cmd():
    # horizontal swipe: mostly leftwards but with a small vertical jitter
...
def gen_small_swipe_cmd():
    # when more than one allowed app is present (split screen), do a short horizontal swipe
    return 'input swipe 594 1539 694 1539\n'
